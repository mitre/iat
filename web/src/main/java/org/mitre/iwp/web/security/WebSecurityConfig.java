...
@Configuration
@ConditionalOnProperty(name = "iwp.security.secured", havingValue = "true")
public class WebSecurityConfig {

  private final IwpUserDetailsService userDetailsService;

  public WebSecurityConfig(@Lazy IwpUserDetailsService userDetailsService) {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    requestHandler.setCsrfRequestAttributeName("_csrf");
        ...
        // Use desired login page
		http.authorizeHttpRequests(
            auth -> auth.requestMatchers("/css/*", "/fonts/*", "/login").permitAll()
            ...
            .logout(logout -> logout.logoutSuccessUrl("/login").permitAll()).csrf(csrf -> csrf
